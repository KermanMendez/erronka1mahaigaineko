...
|----------|---------|-----------|
| **firebase-admin** | 9.2.0 | SDK principal Firebase Admin |
| **google-cloud-firestore** | 3.13.1 | Base de datos NoSQL Firestore |
| **google-cloud-core** | 2.8.20 | Core Google Cloud |
| **google-cloud-core-grpc** | 2.22.0 | Core gRPC para Google Cloud |
| **google-auth-library-credentials** | 1.19.0 | Credenciales autenticación |
| **google-auth-library-oauth2-http** | 1.19.0 | OAuth2 HTTP |
| **google-api-client** | 2.2.0 | Cliente API Google |

### 🌐 **HTTP & Networking**
| Librería | Versión | Propósito |
|----------|---------|-----------|
| **okhttp** | 3.14.9 | Cliente HTTP moderno |
| **okio** | 1.17.5 | I/O library (dependencia OkHttp) |
| **google-http-client** | 1.43.3 | Cliente HTTP Google |
| **google-http-client-gson** | 1.43.3 | Integración HTTP + Gson |
| **google-http-client-jackson2** | 1.43.3 | Integración HTTP + Jackson |

### 📡 **gRPC & Protobuf**
| Librería | Versión | Propósito |
|----------|---------|-----------|
| **grpc-api** | 1.56.1 | API gRPC |
| **grpc-core** | 1.56.1 | Core gRPC |
| **grpc-stub** | 1.56.1 | Stubs generados |
| **grpc-auth** | 1.56.1 | Autenticación gRPC |
| **grpc-context** | 1.56.1 | Contexto gRPC |
| **grpc-protobuf** | 1.56.1 | Integración Protobuf |
| **grpc-protobuf-lite** | 1.56.1 | Protobuf ligero |
| **grpc-netty-shaded** | 1.56.1 | Netty embebido |
| **grpc-google-cloud-firestore-v1** | 3.13.1 | Cliente Firestore gRPC |
| **protobuf-java** | 3.23.4 | Protocol Buffers Java |
| **protobuf-java-util** | 4.33.0 | Utilidades Protobuf |
| **proto-google-cloud-firestore-v1** | 3.13.1 | Protobuf Firestore |
| **proto-google-common-protos** | 2.25.1 | Protos comunes Google |

### 🔧 **Utilidades & Parsing**
| Librería | Versión | Propósito |
|----------|---------|-----------|
| **gson** | 2.10.1 | Parsing JSON Google |
| **json** | 20230227 | Manipulación JSON |
| **jackson-core** | 2.15.2 | Core Jackson JSON |
| **guava** | 33.0.0-jre | Utilidades Google (colecciones, caché) |
| **api-common** | 2.15.0 | APIs comunes Google |
| **gax** | 2.32.0 | Google API Extensions |
| **gax-grpc** | 2.32.0 | GAX con gRPC |

### 🎨 **UI & Fecha**
| Librería | Versión | Propósito |
|----------|---------|-----------|
| **jdatepicker** | 1.3.4 | Selector de fechas Swing |
| **threetenbp** | 1.6.8 | Backport Java 8 Time API |

### 🔐 **Seguridad & Crypto**
| Librería | Versión | Propósito |
|----------|---------|-----------|
| **jbcrypt** | 0.4 | Hashing BCrypt (legacy) |

### 📊 **Logging & Monitoreo**
| Librería | Versión | Propósito |
|----------|---------|-----------|
| **slf4j-api** | 2.0.9 | API logging SLF4J |
| **slf4j-simple** | 2.0.9 | Implementación simple SLF4J |
| **opencensus-api** | 0.31.1 | Telemetría y tracing |
| **opencensus-contrib-http-util** | 0.31.1 | HTTP tracing |
| **perfmark-api** | 0.26.0 | Marcadores de rendimiento |

### 🛠️ **Soporte**
| Librería | Versión | Propósito |
|----------|---------|-----------|
| **failureaccess** | 1.0.2 | Acceso a fallos Guava |
